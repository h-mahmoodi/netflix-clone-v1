...
type MovieRelatedPageHeaderProps = {
  movie: Movie;
};

const MovieRelatedPageHeader = ({ movie }: MovieRelatedPageHeaderProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.headerContainer}>
        <div className={styles.headerTitle}>Related Movies</div>
...
export default MovieRelatedPageHeader;
