...
import { fetchUpComingMovies } from "@src/fetchers";
...
const AppUpComingMovies = () => {
  ...
  return (
    <div>
      <AppPageHeading title={"UpComing Movies"} />
      <MovieDisplayGrid
        movies={movies}
...
export default AppUpComingMovies;
