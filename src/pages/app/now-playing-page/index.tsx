...
import { fetchNowPlayingMovies } from "@src/fetchers";
...
const AppNowPlayingMovies = () => {
  ...
  return (
    <div>
      <AppPageHeading title={"Now Playing Movies"} />
      <MovieDisplayGrid
        movies={movies}
...
export default AppNowPlayingMovies;
